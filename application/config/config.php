...
// $config['smtp_user'] = 'mingave11@gmail.com'; // Ganti dengan alamat email Anda
// $config['smtp_pass'] = 'aveceena123'; // Ganti dengan password email Anda
