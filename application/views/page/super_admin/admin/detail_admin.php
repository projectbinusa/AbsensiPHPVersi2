...
<head>
    ...
    body {
        ...
        overflow: hidden;
        /* Menonaktifkan scrollbar vertikal */
    }
    ...
    .container {
        ...
        min-height: 100vh;
        overflow: auto;
        /* Mengaktifkan scrollbar vertikal jika diperlukan */
    }
    ...
    @media (max-width: 768px) {
        .container {
            width: 100vw;
            /* Membuat container lebar penuh pada perangkat kecil */
        }
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="email" id="email"
                                ...
                                placeholder=" " autocomplete="off" value="<?php echo $admin->email; ?>" required
                                readonly />
                            <label for="email"
                    ...
                    <div class=" text-left mt-4">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <img class=" max-width-100 max-height-96 " style="margin-bottom: 25px; margin-left: 50px; "
                                src="<?= base_url('/images/admin/' . $admin->image) ?>" alt="image description">
                            <label for="foto"
