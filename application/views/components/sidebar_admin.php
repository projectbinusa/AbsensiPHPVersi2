            ...
            <ul class="space-y-2 font-medium">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="<?php echo base_url(
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Perkaryawan</span>
                            </a>
                        </li>
                        <!-- Menu Harian -->
                        <li>
                ...
                <li>
                    <button type="button"
                        ...
                        <i
                            class="fa-solid fa-clock fa-lg me-3 text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Data Absensi</span>
                        <i
                            class="fa-solid fa-chevron-down fa-lg me-3 text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
                    </button>
