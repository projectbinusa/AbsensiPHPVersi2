        ...
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                ...
                <div class="hidden md:block w-2/5 bg-indigo-500 py-10 px-10">
                    <h1 class="text-slate-50 text-xl text-center mt-0"><b>Selamat Datang DiAbsensi</b></h1>
                ...
                <div class="w-full md:w-3/5 py-10 px-5 md:px-10">
                    <div class="text-center mb-5">
                        <h1 class="font-bold text-3xl text-gray-900">Registrasi</h1>
                        <!-- <p>Enter your information to register</p> -->
                    </div>
                    <hr class="border border-black">
                    <form class="mt-7" action="<?php echo base_url(
                        'auth/aksi_register_superadmin'
                    ); ?>" method="post">
