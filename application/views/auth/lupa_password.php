        ...
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            ...
            <div class="w-full md:w-3/5 py-10 px-5 md:px-10">
                <div class="text-center mb-5">
                    <h1 class="font-bold text-3xl text-gray-900">Lupa Password</h1>
                </div>
                <hr class="border border-black">
                <form class="mt-7" method="post" id="form-login" action="<?= base_url(
                'auth/send_reset_email'
                    ...
                    <div class="flex -mx-3 mt-4">
                            <div class="w-full px-3 mb-10">
                                <button
                                    class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Konfirmasi Email</button>
                            </div>
                        </div>
                </form>
            </div>
